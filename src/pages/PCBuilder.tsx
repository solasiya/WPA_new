...
import { Cpu, Zap, HardDrive, Fan, Monitor, Save, Send } from 'lucide-react';
...
const partsData = {
  ...
  gpu: [
    ...
    { id: 'g4', name: 'NVIDIA RTX 4090 24GB', price: 42000, category: 'Workstation', image: '/assets/gpu/NVIDIA%20RTX%204090%2024GB.png' },
  ],
  ram: [
    { id: 'r1', name: '16GB (2x8GB) DDR5 5200MHz', price: 1200, image: '/assets/ram/16GB%20(2x8GB)%20DDR5%205200MHz.png' },
    { id: 'r2', name: '32GB (2x16GB) DDR5 6000MHz CL30', price: 2800, image: '/assets/ram/32GB%20(2x16GB)%20DDR5%206000MHz%20CL30.png' },
    { id: 'r3', name: '64GB (2x32GB) DDR5 6400MHz', price: 5500, image: '/assets/ram/64GB%20(2x32GB)%20DDR5%206400MHz.png' },
  ],
  motherboard: [
    { id: 'm1', name: 'B650M Micro-ATX (AMD)', price: 2500, image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=200' },
    { id: 'm2', name: 'Z790 ATX WiFi (Intel)', price: 4800, image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=200' },
    { id: 'm3', name: 'X670E E-ATX High-End (AMD)', price: 8500, image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=200' },
  ],
  storage: [
    { id: 's1', name: '1TB NVMe PCIe 4.0 M.2', price: 1400, image: 'https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&q=80&w=200' },
    { id: 's2', name: '2TB NVMe PCIe 4.0 M.2 Gen4', price: 2900, image: 'https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&q=80&w=200' },
    { id: 's3', name: '4TB NVMe PCIe 5.0 M.2', price: 6500, image: 'https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&q=80&w=200' },
  ],
  powerSupply: [
    { id: 'p1', name: '650W 80+ Bronze', price: 1100, image: 'https://images.unsplash.com/photo-1587202372634-32705e3bf49c?auto=format&fit=crop&q=80&w=200' },
    { id: 'p2', name: '850W 80+ Gold Fully Modular', price: 2500, image: 'https://images.unsplash.com/photo-1587202372634-32705e3bf49c?auto=format&fit=crop&q=80&w=200' },
    { id: 'p3', name: '1000W 80+ Platinum ATX 3.0', price: 4200, image: 'https://images.unsplash.com/photo-1587202372634-32705e3bf49c?auto=format&fit=crop&q=80&w=200' },
  ]
};
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3 space-y-6">
            ...
            <div className="glass p-6 rounded-2xl">
             ...
             {/* Other components can be mapped similarly (Motherboard, Storage, PSU) */}
          </div>
